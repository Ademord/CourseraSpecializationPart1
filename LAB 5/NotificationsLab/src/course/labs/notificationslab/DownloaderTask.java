					...
					public void onReceive(Context context, Intent intent) {
						...
						if ( getResultCode() !=  Activity.RESULT_OK ) {
							...
							final PendingIntent pendingIntent = 
									PendingIntent.getActivity(mApplicationContext, 
									MY_NOTIFICATION_ID, restartMainActivtyIntent, 
							...
							Notification.Builder notificationBuilder = new Notification.Builder(
									mApplicationContext)
							.setTicker("This is a very long long notification")
							.setAutoCancel(true)
							...
							nMGR.notify(MY_NOTIFICATION_ID, notificationBuilder.build());
